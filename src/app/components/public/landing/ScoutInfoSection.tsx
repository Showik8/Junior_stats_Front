      ...
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-[var(--gold)]/10 text-[var(--gold)] mb-6 text-sm font-bold tracking-widest border border-[var(--gold)]/20">
              <FaFingerprint />
              პროფესიონალთათვის
            </div>
            ...
            <h2 className="text-4xl md:text-5xl font-black mb-6 leading-tight">
              ...
              <span className="text-[var(--emerald-glow)]">სკაუტებისა და აგენტებისთვის</span>
            </h2>
            
            <p className="text-lg text-[var(--text-secondary)] mb-10 font-light leading-relaxed">
            ...
            <ul className="space-y-6 mb-12">
              <li className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-white/40 flex-shrink-0 border border-white/10">
                  <FaChartLine className="text-xl" />
                </div>
                <div>
                  <h4 className="font-bold text-white mb-1">სიღრმისეული ანალიტიკა</h4>
                  <p className="text-sm text-[var(--text-secondary)]">სრული ინფორმაცია ყოველ მატჩზე და მოთამაშის ტექნიკურ მაჩვენებლებზე.</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-white/40 flex-shrink-0 border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--text-secondary)]">მხოლოდ ავტორიზებული პირებისთვის განკუთვნილი სპორტული რეპორტები.</p>
                </div>
              </li>
            </ul>
            ...
            <Link 
              href="/sign-in" 
              className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-[var(--bg-card-solid)] border border-[var(--emerald-glow)]/40 hover:bg-[var(--emerald-glow)]/10 text-white rounded-xl font-bold transition-all duration-300 shadow-[0_0_20px_-5px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_-5px_rgba(16,185,129,0.5)] w-full sm:w-auto"
            >
              სკაუტის ავტორიზაცია
          ...
          <div className="order-1 lg:order-2 relative h-[500px] w-full flex items-center justify-center">
             {/* Back Glow */}
            <div className="absolute inset-0 bg-gradient-to-r from-[var(--emerald-glow)]/20 to-[var(--gold)]/20 blur-[80px] rounded-full" />
            ...
            <div className="relative glass-card w-full max-w-md h-[400px] rounded-3xl border border-white/10 p-6 flex flex-col gap-4 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
               ...
               <div className="flex items-center gap-4 mb-4">
                 ...
                 <div className="flex-1 space-y-2">
                   ...
                   <div className="h-3 w-1/4 bg-[var(--gold)]/30 rounded animate-pulse" />
                 </div>
               </div>
               ...
               <div className="grid grid-cols-2 gap-4">
                 <div className="h-24 rounded-2xl bg-white/5 border border-white/5 flex flex-col items-center justify-center gap-2">
                   ...
                   <div className="text-xs text-[var(--text-secondary)]">პასების სიზუსტე</div>
                 </div>
                 <div className="h-24 rounded-2xl bg-white/5 border border-white/5 flex flex-col items-center justify-center gap-2">
                   <div className="text-2xl font-black text-white">14.5</div>
                   <div className="text-xs text-[var(--text-secondary)]">გარბენი (კმ)</div>
                 </div>
               </div>
               ...
               <div className="flex-1 rounded-2xl bg-white/5 border border-white/5 overflow-hidden flex items-end p-4 gap-2">
                 {[40, 70, 45, 90, 65, 80, 50].map((h, i) => (
                    <div key={i} className="flex-1 bg-gradient-to-t from-[var(--emerald-glow)]/40 to-transparent rounded-t-sm" style={{ height: `${h}%` }} />
                 ))}
               </div>
            </div>
